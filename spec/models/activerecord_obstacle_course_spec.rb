...
describe 'ActiveRecord Obstacle Course' do
  ...
  it '5. finds multiple items by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    items = Item.find(ids[0], ids[1], ids[2])
    # ------------------------------------------------------------
  ...
  it '16. returns the names of users who ordered one specific item' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    users = User.joins(:order_items).where("order_items.item_id == 7")
    .order(:name).distinct.pluck(:name)
    # ------------------------------------------------------------
  ...
  it '18. returns the names of items for a users order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    user = User.find(3)
     items_for_user_3_third_order = user.orders[2].items.pluck(:name)
    # ------------------------------------------------------------
  ...
  it '20. returns the average amount for all orders for one user' do
    ...
    average = User.find(3).average("amount")
    # ------------------------------------------------------------
